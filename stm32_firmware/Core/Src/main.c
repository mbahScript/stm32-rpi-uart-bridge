...
/**
  ******************************************************************************
  * @file           : main.c
  * @brief          : STM32F767 ↔ RPi5 UART Transport Protocol v0.4.0 (USART3)
  ******************************************************************************
...
static char     last_reply_frame[TX_PAYLOAD_SIZE];
...
static void handle_complete_message(const char *msg)
{
    ...
    *last_bar = '\0'; // now copy = "TYPE|NODE|SEQ|DATA"
    ...
    if (strcmp(type, "CMD") == 0)
    {
        ...
        {
            /* v0.4.0: Host sends compact real-time TfL summary (already formatted on Pi) */
